...
/** Generated Model for PP_Calendar
...
public class X_PP_Calendar extends PO implements I_PP_Calendar, I_Persistent 
{
    ...
    {
      super (ctx, PP_Calendar_ID, trxName);
      /** if (PP_Calendar_ID == 0)
        {
			setName (null);
			setPP_Calendar_ID (0);
    ...
    /** Load Constructor */
    public X_PP_Calendar (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_PP_Calendar[")
