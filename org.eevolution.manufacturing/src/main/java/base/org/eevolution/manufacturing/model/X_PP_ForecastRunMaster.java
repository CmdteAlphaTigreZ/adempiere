...
public class X_PP_ForecastRunMaster extends PO implements I_PP_ForecastRunMaster, I_Persistent 
{
	...
	public org.eevolution.manufacturing.model.I_PP_ForecastDefinitionLine getPP_ForecastDefinitionLine() throws RuntimeException
    {
		return (org.eevolution.manufacturing.model.I_PP_ForecastDefinitionLine)MTable.get(getCtx(), org.eevolution.manufacturing.model.I_PP_ForecastDefinitionLine.Table_Name)
