...
@Tag("eevolution")
@Tag("Manufacturing")
class IT_AbstractMakeToOrder extends CommonGWSetup {
    ...
    Timestamp today = TimeUtil.trunc(new Timestamp(System.currentTimeMillis()),
            "DD/MM/YYYY");
    ...
    public void assertPPOrderAreEqual(I_PP_Order expected, I_PP_Order actual,
            String message) {
