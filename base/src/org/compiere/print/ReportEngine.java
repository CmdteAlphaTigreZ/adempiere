...
//		"C_DunningRunEntry_v","PP_Order_Header_v","DD_Order_Header_v" };
	...
	private static final int[]	DOC_TABLE_ID = new int[] {
		...
		MDunningRunEntry.Table_ID, RefactoryUtil.PP_Order_Table_ID, RefactoryUtil.DD_Order_Table_ID , X_HR_PaySelectionCheck.Table_ID ,  X_HR_PaySelectionCheck.Table_ID , MMovement.Table_ID};
