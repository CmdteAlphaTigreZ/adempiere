...
// N
	...
	{
		set_Value (COLUMNNAME_IsCreateMove, Boolean.valueOf(IsCreateMove));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsCreateMove);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Qty Completed.
		@param QtyCompleted Qty Completed	  */
	public void setQtyCompleted (BigDecimal QtyCompleted)
	{
		set_Value (COLUMNNAME_QtyCompleted, QtyCompleted);
	}

	/** Get Qty Completed.
		@return Qty Completed	  */
	public BigDecimal getQtyCompleted () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_QtyCompleted);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
